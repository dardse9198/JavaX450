...
public class MultiArray {
    public static void main(String[] args) {
        ...
        System.out.println("intArrays[0]: " + intArrays[0]);  // 0번째 열의 주소값 (1차원 배열을 가리킴)
        System.out.println("intArrays[1][2]: " + intArrays[1][2]);  // 기본값 0으로 초기화

        // 다차원 배열의 경우, 몇개의 배열이 모여있는지만 지정할 수도 있고
        // 각 배열의 길이는 각각 다르게 만들어줄 수도 있다.
        // 이러한 배열을 가변형 배열이라고 한다.
        intArrays = new int[4][]; // 몇개의 배열이 있는지는 미리 지정해야함
