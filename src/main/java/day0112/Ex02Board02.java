package day0112;//package day0112;
//
...
//
//public class Ex02Board02 {
//    public static final Scanner SCANNER = new Scanner(System.in);
//    public static int nextId = 1;
//    public static Board[] boardArray = new Board[nextId];
//
...
//
//            //boardArray = new Board[nextId] ;
//            boardArray = add(boardArray, b);
...
//
//        printOne(id);  // 수정한 내용 다시 보여줌
//    }
//    public static int findIndexById(int id){
//        for(int i = 0; i < size(boardArray); i++){
//
